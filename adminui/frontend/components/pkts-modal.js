export class PKTSModal extends HTMLElement {
            ...
            <div id="confirm-modal"
                ...
                <div class="modal-content" style="border-color:${accentColor}">
                    ...
                    <div class="save-cancel">
                        <pkts-button type="button" id="confirm-no" label="Cancel" theme="Shadow" righticon="x"></pkts-button>
                        <pkts-button
                            id="confirm-yes"
                            ${
...
customElements.define("pkts-modal", PKTSModal);
